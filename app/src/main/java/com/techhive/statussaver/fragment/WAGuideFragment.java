...
public class WAGuideFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Glide.with(mContext)
                .load(ContextCompat.getDrawable(mContext, R.drawable.wb_step_1))
                .into(help1);

        Glide.with(mContext)
                .load(ContextCompat.getDrawable(mContext, R.drawable.wb_step_2))
                .into(help2);

        Glide.with(mContext)
                .load(ContextCompat.getDrawable(mContext, R.drawable.wb_step_3))
                .into(help3);
