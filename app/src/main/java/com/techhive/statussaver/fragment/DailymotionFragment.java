...
public class DailymotionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
        ...
        ((MyGalleryActivity) requireActivity()).txtToolbarName.setText(getResources().getString(R.string.dailymotion));
        return view;
    }
    ...
    public void loadMedia() {
        ...
        file = Utils.downloadDailymotionDir;
