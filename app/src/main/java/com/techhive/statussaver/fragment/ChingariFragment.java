...
public class ChingariFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
        ...
        ((MyGalleryActivity) requireActivity()).txtToolbarName.setText(getResources().getString(R.string.chingari));
        return view;
    }
    ...
    public void loadMedia() {
        ...
        file = Utils.downloadChinagriDir;
