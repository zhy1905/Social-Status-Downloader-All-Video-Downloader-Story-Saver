...
public class TrillerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
        ...
        ((MyGalleryActivity)requireActivity()).txtToolbarName.setText(getResources().getString(R.string.triller));
        return view;
    }
